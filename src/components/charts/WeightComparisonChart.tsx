  ...
  const data = useMemo(() => {
    ...
    return groups.map(g => {
      ...
      return {
        ...
        fullName: g.name,
        conservative: Number(cons.weightShiftPp.toFixed(2)),
        moderate: Number(mod.weightShiftPp.toFixed(2)),
        transformative: Number(trans.weightShiftPp.toFixed(2)),
        _sortKey: mod.aiImpactPp,
      };
    ...
    <div className="bg-[#13131d] border border-[#2a2a3a] rounded-md p-4">
      <div className="mb-4">
        ...
        <p className="text-[10px] text-[#606070]">
          AI-driven weight change (pp) by major group across all scenarios
        </p>
      </div>
